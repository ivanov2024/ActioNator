...
namespace ActioNator.Data.Migrations
{
    ...
    [Migration("20250711085938_AchievementTemplateSeed")]
    partial class AchievementTemplateSeed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActioNator.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("RegisteredAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 710, DateTimeKind.Utc).AddTicks(3285));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 713, DateTimeKind.Utc).AddTicks(7887));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 714, DateTimeKind.Utc).AddTicks(5949));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Goal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 715, DateTimeKind.Utc).AddTicks(7899));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.JournalEntry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 716, DateTimeKind.Utc).AddTicks(4972));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Message", b =>
                {
                    ...
                    b.Property<DateTime>("PostedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 721, DateTimeKind.Utc).AddTicks(175));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 11, 8, 59, 37, 721, DateTimeKind.Utc).AddTicks(9003));
