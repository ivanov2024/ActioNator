...
namespace ActioNator.Data.Migrations
{
    ...
    [Migration("20250727144013_UpdatedTheDefaultUserProfilePicture")]
    partial class UpdatedTheDefaultUserProfilePicture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActioNator.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("RegisteredAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 475, DateTimeKind.Utc).AddTicks(8554));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 480, DateTimeKind.Utc).AddTicks(3881));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 481, DateTimeKind.Utc).AddTicks(3867));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Goal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 482, DateTimeKind.Utc).AddTicks(6840));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.JournalEntry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 483, DateTimeKind.Utc).AddTicks(5353));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Message", b =>
                {
                    ...
                    b.Property<DateTime>("PostedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 488, DateTimeKind.Utc).AddTicks(2181));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 27, 14, 40, 9, 489, DateTimeKind.Utc).AddTicks(1657));
