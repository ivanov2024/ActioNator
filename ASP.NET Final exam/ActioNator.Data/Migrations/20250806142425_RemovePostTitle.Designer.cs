...
namespace ActioNator.Data.Migrations
{
    ...
    [Migration("20250806142425_RemovePostTitle")]
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 6, 14, 24, 24, 178, DateTimeKind.Utc).AddTicks(1597));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 6, 14, 24, 24, 179, DateTimeKind.Utc).AddTicks(3180));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Goal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 6, 14, 24, 24, 183, DateTimeKind.Utc).AddTicks(654));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.JournalEntry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 6, 14, 24, 24, 184, DateTimeKind.Utc).AddTicks(4572));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Message", b =>
                {
                    ...
                    b.Property<DateTime>("PostedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 6, 14, 24, 24, 189, DateTimeKind.Utc).AddTicks(6125));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 6, 14, 24, 24, 190, DateTimeKind.Utc).AddTicks(7338));
