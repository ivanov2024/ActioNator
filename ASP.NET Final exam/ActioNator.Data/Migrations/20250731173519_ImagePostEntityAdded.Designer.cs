...
namespace ActioNator.Data.Migrations
{
    ...
    [Migration("20250731173519_ImagePostEntityAdded")]
    partial class ImagePostEntityAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActioNator.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("RegisteredAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 340, DateTimeKind.Utc).AddTicks(7212));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 344, DateTimeKind.Utc).AddTicks(9070));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 345, DateTimeKind.Utc).AddTicks(7059));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Goal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 346, DateTimeKind.Utc).AddTicks(9495));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.JournalEntry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 348, DateTimeKind.Utc).AddTicks(781));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Message", b =>
                {
                    ...
                    b.Property<DateTime>("PostedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 351, DateTimeKind.Utc).AddTicks(9318));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 31, 17, 35, 18, 352, DateTimeKind.Utc).AddTicks(6662));
