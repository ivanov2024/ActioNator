...
namespace ActioNator.Data.Migrations
{
    ...
    [Migration("20250814122542_AddUserReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 14, 12, 25, 41, 52, DateTimeKind.Utc).AddTicks(3139));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 14, 12, 25, 41, 53, DateTimeKind.Utc).AddTicks(2612));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Goal", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 14, 12, 25, 41, 56, DateTimeKind.Utc).AddTicks(5094));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.JournalEntry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 14, 12, 25, 41, 57, DateTimeKind.Utc).AddTicks(6195));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Message", b =>
                {
                    ...
                    b.Property<DateTime>("PostedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 14, 12, 25, 41, 62, DateTimeKind.Utc).AddTicks(4361));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 8, 14, 12, 25, 41, 63, DateTimeKind.Utc).AddTicks(2897));
            ...
            modelBuilder.Entity("ActioNator.Data.Models.UserReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ActioNator.Data.Models.UserReport", b =>
                {
                    ...
                    b.HasOne("ActioNator.Data.Models.ApplicationUser", "ReportedUser")
                        .WithMany()
